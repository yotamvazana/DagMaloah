...
// End Cross Module References
	...
	DEFINE_FUNCTION(UAIMovementHandler::execSetRayDistance)
	{
	...
	DEFINE_FUNCTION(UAIMovementHandler::execSetAngle)
	{
	...
	void UAIMovementHandler::StaticRegisterNativesUAIMovementHandler()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetAngle", &UAIMovementHandler::execSetAngle },
			{ "SetRayDistance", &UAIMovementHandler::execSetRayDistance },
	...
	struct Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics
	{
		struct AIMovementHandler_eventSetAngle_Parms
		{
			float angle;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::NewProp_angle = { "angle", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIMovementHandler_eventSetAngle_Parms, angle), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::NewProp_angle,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AIMovementHandler.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAIMovementHandler, nullptr, "SetAngle", nullptr, nullptr, sizeof(AIMovementHandler_eventSetAngle_Parms), Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAIMovementHandler_SetAngle()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAIMovementHandler_SetAngle_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics
	{
		struct AIMovementHandler_eventSetRayDistance_Parms
		{
			float distance;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::NewProp_distance = { "distance", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIMovementHandler_eventSetRayDistance_Parms, distance), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::NewProp_distance,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AIMovementHandler.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAIMovementHandler, nullptr, "SetRayDistance", nullptr, nullptr, sizeof(AIMovementHandler_eventSetRayDistance_Parms), Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAIMovementHandler_SetRayDistance()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAIMovementHandler_SetRayDistance_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAIMovementHandler_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAIMovementHandler_GetEmptyDirection, "GetEmptyDirection" }, // 1923709670
		{ &Z_Construct_UFunction_UAIMovementHandler_SetAngle, "SetAngle" }, // 3593145149
		{ &Z_Construct_UFunction_UAIMovementHandler_SetRayDistance, "SetRayDistance" }, // 3996722338
		{ &Z_Construct_UFunction_UAIMovementHandler_ShootRaycast, "ShootRaycast" }, // 579238237
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAIMovementHandler, 214913261);
