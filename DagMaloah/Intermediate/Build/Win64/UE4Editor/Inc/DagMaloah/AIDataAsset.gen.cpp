...
// End Cross Module References
	DEFINE_FUNCTION(UAIDataAsset::execGetRandomDeathChance)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)Z_Param__Result=P_THIS->GetRandomDeathChance();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UAIDataAsset::execGetRandomRayDistanceCheck)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=P_THIS->GetRandomRayDistanceCheck();
		P_NATIVE_END;
	}
	...
	{
		struct AIDataAsset_eventGetRandomDeathChance_Parms
		{
			int32 ReturnValue;
		};
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIDataAsset_eventGetRandomDeathChance_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AIDataAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAIDataAsset, nullptr, "GetRandomDeathChance", nullptr, nullptr, sizeof(AIDataAsset_eventGetRandomDeathChance_Parms), Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAIDataAsset_GetRandomDeathChance_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics
	{
		struct AIDataAsset_eventGetRandomRayDistanceCheck_Parms
		{
			float ReturnValue;
		};
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIDataAsset_eventGetRandomRayDistanceCheck_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AIDataAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAIDataAsset, nullptr, "GetRandomRayDistanceCheck", nullptr, nullptr, sizeof(AIDataAsset_eventGetRandomRayDistanceCheck_Parms), Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp__maxDeathChance_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp__maxDeathChance;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAIDataAsset_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAIDataAsset_GetRandomRayDistanceCheck, "GetRandomRayDistanceCheck" }, // 2681905502
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAIDataAsset_Statics::NewProp__maxDeathChance_MetaData[] = {
		{ "Category", "AIDataAsset" },
		{ "ModuleRelativePath", "AIDataAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UAIDataAsset_Statics::NewProp__maxDeathChance = { "_maxDeathChance", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAIDataAsset, _maxDeathChance), METADATA_PARAMS(Z_Construct_UClass_UAIDataAsset_Statics::NewProp__maxDeathChance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAIDataAsset_Statics::NewProp__maxDeathChance_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAIDataAsset_Statics::NewProp__minDeathChance_MetaData[] = {
		{ "Category", "AIDataAsset" },
		{ "ModuleRelativePath", "AIDataAsset.h" },
	};
#endif
